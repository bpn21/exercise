...
console.log("apple.origin", apple.origin)
var mango = new Fruits();
console.log("mango origin", mango.origin = 'china') //
var orange = new Fruits();
var papaya = new Fruits();
var banana = new Fruits();


console.log("type of ", typeof (apple))  // object , object Fruits { name: undefined, origin: 'china', price: 'Rs undefined' }
console.log("type of ",typeof (mango));
console.log(orange);
console.log(papaya);
console.log(banana);
